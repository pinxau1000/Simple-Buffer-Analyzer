...
int main(int argc, char** argv)
{
    ...
    TCLAP::UnlabeledValueArg<double> arg_bit_rate("bit_rate", "Bit-rate of the network. ((defined -u)/s)", true, 0, "double", cmdParser);
    TCLAP::UnlabeledValueArg<double> arg_buffer_length("buffer_length", "Buffer length or size. (defined -u)", true, 0, "double", cmdParser);
    ...
    analyze(
            arg_csv_file.getValue(),
            arg_bit_rate.getValue(),
            arg_buffer_length.getValue(),
